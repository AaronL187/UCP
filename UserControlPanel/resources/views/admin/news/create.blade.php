...
<div class="containerv3 mt-5" >
    <div class="row">
        <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1 col-sm-12">
            <h2 class="mb-4 text-center">Hirdetmény létrehozása</h2>
            @if($errors->any())
            ...
            @endif
            <form action="{{url('news/store')}}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                ...
                <button type="submit" class="btn btn-primary btn-block">Mehet</button>
            </form>
        </div>
    </div>
</div>
