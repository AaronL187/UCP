...
<div class="container-fluid page-body-wrapper">
    ...
    <div class="container" align="center" style="padding-top: 100px">
        ...
        @endif
            <form action="{{ url('room/update', $rooms['id'])}}" method="post">
            @csrf
            <div class="fillable">
                <div style="padding: 15px;">
                    <label>Szoba neve:</label>
                    <input type="text" style="color:black" name="name" placeholder="Add meg a szoba nevét" value="{{$rooms['name']}}">
                </div>
                <div style="padding: 15px;">
                    <label for="opening-time">Nyitvás:</label>
                    <input value="{{$rooms['opening']}}" type="time" id="opening" name="opening" style="color: black">
                </div>

                <div style="padding: 15px;">
                    <label for="opening-time">Zárás:</label>
                    <input value="{{$rooms['closing']}}" type="time" id="closing" name="closing" style="color: black">
                </div>
